...
def reduce_rfa(target, sources):
    # source: https://github.com/krishnap25/geom_median/blob/main/src/geom_median/torch/weiszfeld_array.py
    # https://github.com/krishnap25/geom_median/tree/main
    n_clients = len(sources)
    ...
    # Ensure total_sum is a tensor
    total_sum = total_sum if isinstance(total_sum, torch.Tensor) else torch.tensor(total_sum)
